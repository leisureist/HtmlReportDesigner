/*globals $, rptEditor, svgedit, svgCanvas, DOMParser*/
...
rptEditor.addExtension("imagelib", function() {'use strict';

	var uiStrings = rptEditor.uiStrings;
	...
	var img_libs = [{
			...
			url: rptEditor.curConfig.extPath + 'imagelib/index.html',
...
//				});
	...
	return {
		svgicons: rptEditor.curConfig.extPath + "ext-imagelib.xml",
		buttons: [{
			id: "tool_imagelib",

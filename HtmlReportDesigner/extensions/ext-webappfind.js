...
window.addEventListener('message', function(e) {
    ...
    switch (messageType) {
        case 'webapp-view':
            ...
            svgString = e.data[2];
            rptEditor.loadFromString(svgString);
...
rptEditor.addExtension('WebAppFind', function() {

    return {
        name: 'WebAppFind',
        svgicons: rptEditor.curConfig.extPath + 'webappfind-icon.svg',
        buttons: [{
            id: 'webappfind_save', // 
            type: 'app_menu',
            ...
            events: {
                click: function () {
                    ...
                    window.postMessage([saveMessage, pathID, rptEditor.canvas.getSvgString()], window.location.origin);
                }
            }
        }]
    };

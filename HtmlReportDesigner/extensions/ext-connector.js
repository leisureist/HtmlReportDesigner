...
rptEditor.addExtension("Connector", function(S) {
...
//		});
	...
	return {
		name: "Connector",
		svgicons: rptEditor.curConfig.imgPath + "conn.svg",
		buttons: [{
			id: "mode_connect",
			type: "mode",
			icon: rptEditor.curConfig.imgPath + "cut.png",
